...
const getInfo = async(event) => {
    ...
    if(cityVal === ""){
        ...
        try{
            let urlm=`http://api.openweathermap.org/data/2.5/weather?q=${cityVal}&units=metric&appid=3430225322111aa367c05d37970d5e02`;
...
const getCurrentDate =()=>{
    ...
    let dd_mm=document.getElementById('today_date');
    dd_mm.innerHTML=date+ "-" +month;
